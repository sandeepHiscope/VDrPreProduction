  ...
  return (
    <div>
      <div className="insurancefrompage3-div1">
        <h2>ONE LAST STEP</h2>
        <p>
          Choose Rider Benefits which offer extra coverage which can be helpful
      ...
      <div className="insurancefrompage3-div2">
        <ul>
          <li>
            <h4>
              Accident Benefits Reuired?<p>*</p>
            </h4>
            <input type="text" id="accident-benefits" />
            <a href="">What are this Riders?</a>
          </li>
          <li>
            <h4>
              ADDB Required Sum Assured?<p>*</p>
            </h4>
            <input type="text" id="addb-sum-assured" />
